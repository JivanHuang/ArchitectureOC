...
@interface _SBUIControlBlockTarget : NSObject
...
@implementation _SBUIControlBlockTarget
...
- (void)addBlockForControlEvents:(UIControlEvents)controlEvents
	...
	_SBUIControlBlockTarget *target = [[_SBUIControlBlockTarget alloc]
...
- (void)removeAllBlocksForControlEvents:(UIControlEvents)controlEvents {
	...
	[targets enumerateObjectsUsingBlock: ^(id obj, NSUInteger idx, BOOL *stop) {
	         _SBUIControlBlockTarget *target = (_SBUIControlBlockTarget *)obj;
